...
LAYOUT( /* Right */
  ...
  _______, RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_VAD,  RGB_SAI,  RGB_SAD,  RGB_HUI,  RGB_HUD,  RGB_SPI,  RGB_SPD,  _______,
...
LAYOUT( /* Left */
  ...
  _______, RGB_MODE_RAINBOW, _______, _______, _______, _______, _______, KC_UNDERSCORE, KC_PLUS, KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE, KC_PIPE,
